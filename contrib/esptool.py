...
class ESPLoader(object):
    ...
    def _connect_attempt(self, mode='default_reset', esp32r0_delay=False):
        ...
        if mode != 'no_reset':
            ...
            time.sleep(0.1 * DTR_RTS_SLEEP_GAIN)
            if esp32r0_delay:
            ...
            # time.sleep(0.05 * DTR_RTS_SLEEP_GAIN)
            time.sleep(2)
...
# Begin makeblock 20190704 by fftust
extern_uploader_process_show_function = None
extern_uploader_process_show_info = ""

def set_extern_show_function(func, info = ""):
    global extern_uploader_process_show_function
    global extern_uploader_process_show_info

    extern_uploader_process_show_function = func
    extern_uploader_process_show_info = info

# End makeblock 20190704 by fftust
...
# End makeblock 20190704 by fftust
    ...
    for address, argfile in args.addr_filename:
        ...
        while len(image) > 0:
            ...
            sys.stdout.flush()
# Begin makeblock 20190704 by fftust
            if extern_uploader_process_show_function:
                extern_uploader_process_show_function(extern_uploader_process_show_info, 100 * (seq + 1) // blocks)
